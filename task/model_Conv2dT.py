...
class HourGlass(model):
    ...
    def _generate_network(self, level):
        ...
        self.layers_dict['Conv2DTranspose'] = layers.Conv2DTranspose(256, (4, 4), padding='same', data_format='channels_last', strides=2, activation='LeakyReLU')
        if level > 1:
        ...
        self.layers_dict['last'] = layers.Conv2D(256, (1, 1))
